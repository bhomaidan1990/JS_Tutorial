...
import { createBase, createLego } from "./modelCreator.js";
let container;
let camera;
let renderer;
let scene;
...
export default function init() {
    ...
    ***************************************************/
    ...
    createLego(lego_2x2_pos, "white", 1, scene);

    const lego_2x2_pos2 = new Vector3(1, 0, 0);
    createLego(lego_2x2_pos2, "olive", 3, scene);

    const lego_2x4_pos = new Vector3(0, 2, 1);
    createLego(lego_2x4_pos,"yellow", 2, scene, 4, false);
